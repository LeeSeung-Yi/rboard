...
function LoginPage(props) {
    ...
    const loginMutation = useMutation({
        ...
        onSuccess: async(data) => {
            setAuth(data); //토큰 저장
            await queryClient.invalidateQueries({ queryKey: ["me"]}); //토큰 저장을 기다렸다가 저장이 되면(초기화 되면) 이동하겠다는 뜻
            navigate("/posts")
        }
    });
    ...
    return (
        <Container maxWidth='sm'>
            <Paper sx={{
                ...
                <Typography variant='body2' color='text.secondary' mb={3}>이메일과 비밀번호룰 입력하세요</Typography>
